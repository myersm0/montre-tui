...
pub struct Theme {
	...
	pub kwic_right: Style,
	pub kwic_selected: Style,
	pub hints_bar: Style,
	pub hints_key: Style,
...
impl Theme {
	pub fn default_dark() -> Self {
		...
		Self {
			...
			kwic_meta: Style::default().fg(dim),
			kwic_left: Style::default().fg(dim),
			kwic_match: Style::default().fg(accent).add_modifier(Modifier::BOLD),
			kwic_right: Style::default().fg(dim),
			kwic_selected: Style::default().bg(cursor_bg),
